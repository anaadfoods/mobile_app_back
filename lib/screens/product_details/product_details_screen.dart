    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          IconButton(
          onPressed: () {
            _showDetailModal(context, label);
          },
          icon: Icon(
...
void _showDetailModal(BuildContext context, String itemDetail) {
      ...
      builder: (BuildContext context) {
        return Container(
          ...
          child: Column(
            ...
            children: [
              Text('Item Detail', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
              SizedBox(height: 10),
              Text('You clicked on: $itemDetail'),
            ],
          ),
        );
      },
