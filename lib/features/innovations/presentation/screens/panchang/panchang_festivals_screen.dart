...
import 'package:grocery_app/features/innovations/presentation/cubit/panchang_festivals_cubit.dart';
import 'package:grocery_app/features/innovations/presentation/cubit/panchang_festivals_state.dart';
...
class _PanchangFestivalsScreenState extends State<PanchangFestivalsScreen>
          ...
          children: [
            Icon(
              ...
              color:
                  isSelected
                      ? AppColors.parchment
                      : (isDark ? AppColors.parchment54 : AppColors.charcoal),
            ),
      ...
      child: Column(
        ...
        children: [
          ...
          AutoSizeText(
            ...
            style: TextStyle(
              fontSize: 15,
              color: isDark ? AppColors.parchment54 : AppColors.charcoal,
            ),
          ),
        ],
      ),
      ...
      child: Row(
        children: [
          ...
          Icon(
            ...
            color: isDark ? AppColors.pureWhite : AppColors.charcoal26,
          ),
        ],
      ),
    );
  ...
  Widget _buildSearchStatsCard(
    ...
    return Container(
      ...
      child: Row(
        children: [
          Icon(Icons.search_rounded, color: isDark ? AppColors.pureWhite : AppColors.parchment, size: 20),
