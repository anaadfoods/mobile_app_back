...
class _SubscriptionDetailScreenState
  ...
  Future<void> _loadSubscription(String id) async {
    context.read<SubscriptionCubit>().fetchSubscriptionDetails(int.parse(id));
  }
  ...
  Future<void> _downloadAndOpenInvoice(InvoiceEntity invoice) async {
    SnackBarHelper.showInfo(context, 'Downloading ${invoice.displayName}...');
    await Future.delayed(const Duration(seconds: 1));
    SnackBarHelper.showSuccess(context, 'Invoice downloaded');
  }
  ...
  Widget build(BuildContext context) {
    // Outer BlocListener must wrap everything including the loading state,
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    '${item.weightUnit} ├ù ${item.quantity} units',
                    style: theme.textTheme.bodySmall?.copyWith(
