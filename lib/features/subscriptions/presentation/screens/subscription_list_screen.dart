      ...
      child: Container(
        ...
        child: Stack(
          children: [
            ...
            // // SubscriptionEntity icon with light white background
            // Positioned(
...
class _SubscriptionCardState extends State<_SubscriptionCard> {
  ...
  void _togglePauseSubscription(DateTime? startDate, DateTime? endDate) {
    ...
    // The BlocListener in SubscriptionListScreen will catch the success/error and refresh the UI
  ...
  Widget _buildProductImage(SubscriptionEntity subscription, bool isDark) {
    if (subscription.items.isNotEmpty &&
